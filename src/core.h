...
#define is_object(x)     (((uintptr_t)x & 0x6) == 0x6)
...
#define is_list(x)       (((uintptr_t)x & 0x1) == 0x1) 
#define is_pair(x)       (((uintptr_t)x & 0x1) == 0x1) && (((uintptr_t)x & 0x2) != 0x2)
#define is_atom(x)       (((uintptr_t)x & 0x1) == 0x0) && (((uintptr_t)x & 0x2) != 0x2) && (((uintptr_t)x & 0x4) != 0x4) && (((uintptr_t)x & 0x6) != 0x6)
#define untag_object(x)  ((uintptr_t) x & ~0x6)
#define tag_object(x)    ((uintptr_t) x | 0x6)
